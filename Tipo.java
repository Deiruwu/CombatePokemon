...
public class Tipo {
    String nombre;
    List<RelacionTipo> debilidades = null;
    List<RelacionTipo> resistencias = null;
    List<RelacionTipo> inmunidades = null;

    //public static Tipo acero = new Tipo("acero");
    public static Tipo agua = new Tipo("agua");
    /*
    ...
    */
    public static Tipo eléctrico = new Tipo("eléctrico");
    ...
    */
    ...
    public static Tipo planta = new Tipo("planta");
    /* 
    ...
    */
    ...
    public Tipo(String nombre, List<RelacionTipo> debilidades, List<RelacionTipo> resistencias, List<RelacionTipo> inmunidades) {
        this.nombre = nombre;
    ...
    public static void main(String[] args) {
        ...
        agua.debilidades = Arrays.asList(new RelacionTipo(planta, 2), new RelacionTipo(eléctrico, 2));
        agua.resistencias = Arrays.asList(new RelacionTipo(fuego, 0.5), new RelacionTipo(agua, 0.5));

        fuego.debilidades = Arrays.asList(new RelacionTipo(agua, 2));
        fuego.resistencias = Arrays.asList(new RelacionTipo(fuego, 0.5), new RelacionTipo(planta, 0.5));

        planta.debilidades = Arrays.asList(new RelacionTipo(fuego, 2));
        planta.resistencias = Arrays.asList(new RelacionTipo(planta, 0.5), new RelacionTipo(agua, 0.5));

        eléctrico.resistencias = Arrays.asList(new RelacionTipo(eléctrico, 0.5));
    }
    ...
    public List<RelacionTipo> getDebilidades() {
        return debilidades;
    }

    public void setDebilidades(List<RelacionTipo> debilidades) {
        this.debilidades = debilidades;
    }

    public List<RelacionTipo> getResistencias() {
        return resistencias;
    }

    public void setResistencias(List<RelacionTipo> resistencias) {
        this.resistencias = resistencias;
    }

    public List<RelacionTipo> getInmunidades() {
        return inmunidades;
    }

    public void setInmunidades(List<RelacionTipo> inmunidades) {
        this.inmunidades = inmunidades;
    }
}